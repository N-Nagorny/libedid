...
This is a C++ library for parsing and generating EDID binaries. It's targeted against [E-EDID][E-EDID Release A, Revision 2] with EDID structure 1.4 and CTA Extension Version 3 (as described in [CTA-861-G][CTA-861-G]) though it doesn't guarantee full support of them.
...
- Model Year is not supported (Year of Manufacture always used instead).
...
- YCbCr color encodings are named as YCrCb (in [E-EDID][the spec also], maybe due to the order mentioned in [BT.601][BT.601]).
